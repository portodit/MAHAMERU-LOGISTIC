            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="animate-fade-in-left anim-delay-450 mt-6 flex flex-wrap gap-3 sm:gap-4">
                <a
                  ...
                  className="inline-flex h-[50px] items-center justify-center rounded-lg bg-grays px-6 text-[15px] font-semibold text-white shadow-sm transition-colors hover:bg-grays/90 sm:h-[56px] sm:px-8"
                >
                  Layanan Kami
                </a>
                <button
                  ...
                  className="inline-flex h-[50px] items-center justify-center rounded-lg border-2 border-white bg-white px-6 text-[15px] font-semibold text-secondary-600 transition-colors hover:bg-white/90 sm:h-[56px] sm:px-8"
                >
                  Lacak Pengiriman
                </button>
              </div>
